...
impl MoveVmExt {
    pub fn new(
        ...
        let disable_invariant_violation_check = false; // TODO: timed_features.is_enabled(TimedFeatureFlag::DisableInvariantViolationCheckInSwapLoc);

        let type_size_limit = false; // TODO: timed_features.is_enabled(TimedFeatureFlag::EntryTypeSizeLimit);
